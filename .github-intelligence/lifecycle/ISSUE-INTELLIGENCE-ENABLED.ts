 ...
 *
 *   - name: Guard
 *     run: bun .github-intelligence/lifecycle/ISSUE-INTELLIGENCE-ENABLED.ts
 *
 * To ENABLE  Issue Intelligence: ensure `.github-intelligence/ISSUE-INTELLIGENCE-ENABLED.md` exists in the repo.
 * To DISABLE Issue Intelligence: delete `.github-intelligence/ISSUE-INTELLIGENCE-ENABLED.md` and commit the removal.
 *
 * ─────────────────────────────────────────────────────────────────────────────
 * DEPENDENCIES
 * ─────────────────────────────────────────────────────────────────────────────
