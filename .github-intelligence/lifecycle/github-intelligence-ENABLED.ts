/**
 * github-intelligence-ENABLED.ts — Fail-closed guard for the github-intelligence-ENABLED.md sentinel file.
 *
 * ─────────────────────────────────────────────────────────────────────────────
 * PURPOSE
 * ─────────────────────────────────────────────────────────────────────────────
 * This script is the very first step executed in every github-intelligence-* workflow.
 ...
 *
 *   - name: Guard
 *     run: bun .github-intelligence/lifecycle/github-intelligence-ENABLED.ts
 *
 * To ENABLE  Issue Intelligence: ensure `.github-intelligence/github-intelligence-ENABLED.md` exists in the repo.
 * To DISABLE Issue Intelligence: delete `.github-intelligence/github-intelligence-ENABLED.md` and commit the removal.
 *
 * ─────────────────────────────────────────────────────────────────────────────
 * DEPENDENCIES
 * ─────────────────────────────────────────────────────────────────────────────
...
// `.github-intelligence/lifecycle/`.  We step one level up (`..`) to reach `.github-intelligence/`,
// then join with the sentinel filename.
const enabledFile = resolve(import.meta.dir, "..", "github-intelligence-ENABLED.md");
...
console.log("Issue Intelligence enabled — github-intelligence-ENABLED.md found.");

// ─── Requires-heart gate ──────────────────────────────────────────────────────
// If the file `github-intelligence-HEART-REQUIRED.md` exists in the
// `.github-intelligence/` directory, newly opened issues must have a ❤️ (heart)
...
const heartRequiredFile = resolve(import.meta.dir, "..", "github-intelligence-HEART-REQUIRED.md");
  ...
  if (eventPath) {
    ...
    if (parseInt(output.trim(), 10) === 0) {
      console.error(
        ...
        `(github-intelligence-HEART-REQUIRED.md present) but no ❤️ reaction on the issue.\n` +
