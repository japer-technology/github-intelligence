...
<p align="center">
  <picture>
    <img src="https://raw.githubusercontent.com/japer-technology/github-intelligence/main/.github-intelligence/github-intelligence-LOGO.png" alt="Issue Intelligence" width="400">
  </picture>
</p>
...
| File | Purpose |
|------|---------|
| `.github-intelligence/.pi/settings.json` | LLM provider, model, and thinking level |
| `.github-intelligence/AGENTS.md` | Agent identity — name, personality, instructions |
...
Edit `.github-intelligence/.pi/settings.json`:
...
Edit `.github-intelligence/AGENTS.md` to define the agent's identity, name, personality, and behavioral instructions. This file is read at the start of every session.
...
Edit `.github-intelligence/.pi/APPEND_SYSTEM.md` to change the system-level instructions loaded on every session. This file controls:
...
Skills are modular capability packages stored as Markdown files in `.github-intelligence/.pi/skills/`. Each skill defines specific behaviors, instructions, or capabilities the agent can use.
