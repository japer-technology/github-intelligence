...
{
  "issueNumber": 1,
  "sessionPath": ".github-intelligence/state/sessions/2026-02-04T12-00-00-000Z_abc123.jsonl",
...
tail -5 .github-intelligence/state/sessions/*.jsonl

# Search all sessions for a keyword
grep -r "search term" .github-intelligence/state/sessions/
```
...
4. The result is saved to `.github-intelligence/AGENTS.md`
...
```bash
rm .github-intelligence/state/issues/<number>.json
# Find and delete the corresponding session file
rm .github-intelligence/state/sessions/<timestamp>_<id>.jsonl
