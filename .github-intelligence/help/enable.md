...
If you haven't installed Issue Intelligence yet, see [Install](install.md) instead. The sentinel file is included in the `.github-intelligence` folder by default — no extra steps are needed to enable it during initial setup.
