...
- Check that `.github-intelligence/package.json` and `.github-intelligence/bun.lock` are present and valid
- Try running `cd .github-intelligence && bun install` locally to reproduce the error
