...
/** Repository root — two levels above `.github-intelligence/install/`. */
...
console.log("🔧 Installing issue-intelligence into this repository...\n");
...
console.log("  2. Run: cd .github-intelligence && bun install");
