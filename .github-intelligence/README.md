...
|---|---|
| **Single folder, any repo** | Copy `.github-intelligence/` in and run the install script. Nothing to host or maintain. |
...
issue-intelligence lives entirely inside a `.github-intelligence` folder that you drop into your repository.
...
### What's Inside `.github-intelligence/`
...
Set `defaultProvider` and `defaultModel` in `.github-intelligence/.pi/settings.json` and add the matching API key as a repository secret:
