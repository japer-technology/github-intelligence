# .github-intelligence 🦞 Quick Start
...
## What's in the `.github-intelligence` folder
...
**Change the model** — edit `.github-intelligence/.pi/settings.json`:
...
`.pi` supports a wide range of LLM providers out of the box. Set `defaultProvider` and `defaultModel` in `.github-intelligence/.pi/settings.json` and add the matching API key to your workflow:
